...
def checkArguments(action,operatingSystem):
    checkAction = action in ['register','deregister']
    checkOperatingSystem = operatingSystem in [
        'SUSE',
        'WINDOWS',
        'UBUNTU',
        'DEBIAN',
...
def retrieveAWSDefaultPatchBaselineForOperatingSystem(operatingSystem):
    ...
    mapAWSDefaultPatchBaselines = {
        'REDHAT_ENTERPRISE_LINUX': "arn:aws:ssm:eu-central-1:416089608788:patchbaseline/pb-002f93afc8c43b096",
        'CENTOS': "arn:aws:ssm:eu-central-1:416089608788:patchbaseline/pb-0081b03b93d656fb9",
        'AMAZON_LINUX_2': "arn:aws:ssm:eu-central-1:416089608788:patchbaseline/pb-043cba60253bab521",
        'AMAZON_LINUX': "arn:aws:ssm:eu-central-1:416089608788:patchbaseline/pb-056d4257efe913420",
        'DEBIAN': "arn:aws:ssm:eu-central-1:416089608788:patchbaseline/pb-0995d101011ef0d2d",
        'WINDOWS': "arn:aws:ssm:eu-central-1:416089608788:patchbaseline/pb-0af17a967557961db",
        'SUSE': "arn:aws:ssm:eu-central-1:416089608788:patchbaseline/pb-0b2a80796f793fc54",
        'UBUNTU': "arn:aws:ssm:eu-central-1:416089608788:patchbaseline/pb-0f40e1898bd7e2eca",
    }
...
if __name__ == '__main__':
    ...
    try:
        if len(sys.argv) != 4:
            print(
                f"Missing argument : {sys.argv[0]} <register|deregister> <baselineId> <opertingSystem>"
            )
            sys.exit()
            ...
            if checkArguments(action,operatingSystem):
                ...
                print(
                    f"Default Patch Baseline for operatingSystem {operatingSystem} : {response['BaselineId']}"
                )
